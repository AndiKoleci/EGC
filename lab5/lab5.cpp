...
void Lab5::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(3, 2.f, 0));
        modelMatrix = glm::rotate(modelMatrix, RADIANS(30.0f), glm::vec3(1, 0, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.52, 0.52, 0.52));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }

    {
        ...
        modelMatrix = glm::rotate(modelMatrix, RADIANS(15.0f), glm::vec3(0, 1, 0));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.74, 0.74, 0.74));
        RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
    }
