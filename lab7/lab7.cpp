...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int shiny_loc = glGetUniformLocation(shader->program, "material_shininess");
    glUniform1i(shiny_loc, materialShininess);
    int kd_loc = glGetUniformLocation(shader->program, "material_kd");
    glUniform1f(kd_loc, materialKd);
    int ks_loc = glGetUniformLocation(shader->program, "material_ks");
    glUniform1f(ks_loc, materialKs);
    int color_loc = glGetUniformLocation(shader->program, "object_color");
